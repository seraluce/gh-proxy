...
const PROXY_RULE_PATHS = {
    ...
    '/rules/surge': 'direct_surge.txt',
    '/rules/shadowrocket': 'direct_shadowrocket.conf',
    '/rules/v2ray': 'direct_v2ray.txt',
    ...
    if (path === '/rules' || path === '/rules/') {
        return new Response(JSON.stringify({
            ...
            files: {
                ...
                'direct_clash.yaml': '/rules/clash',
                'direct_surge.txt': '/rules/surge',
                'direct_shadowrocket.conf': '/rules/shadowrocket',
                'direct_v2ray.txt': '/rules/v2ray',
            },
            quickLinks: {
                'TXT (通用)': '/rules/direct',
                'Clash': '/rules/clash',
                'Surge': '/rules/surge',
                'Shadowrocket (小火箭)': '/rules/shadowrocket',
                'V2Ray': '/rules/v2ray',
            },
        }, null, 2), {
